...
12. For premium/high-effort execution, consider an early checkpoint after diagnosis, architecture, migration planning, or the first bounded milestone. If the hard reasoning is resolved and the remaining work is mechanical or strongly testable, route the remaining execution back to Luna/Terra or otherwise reduce effort/parallelism when practical.
