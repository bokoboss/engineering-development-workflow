...
- Release automation is fail-closed: existing tags are never retargeted, existing releases are left unchanged, and historical backfill is limited to explicitly verified v1.7.0/v1.7.1 SHAs.
